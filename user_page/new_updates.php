...
.content textarea:focus {
	...
	<div class="desctop">
		<div class="container">
			<h1>Написать новое обновление</h1>
		</div>
	</div>
	...
	<div class="decor">
		<h4>Ознакомьтесь с правилами оформления обновлений</h4><br>
	...
	<form action="../updates/add_new_updates.php" method="post">
		<label for="title">Заголовок обновления</label><br>
		<input required type="text" placeholder="Заголовок обновления" name="title" id="title"><br>
		...
		<label for="text">Текст обновления</label><br>
		<textarea required placeholder="Текст обновления" name="text" id="text"></textarea><br>
