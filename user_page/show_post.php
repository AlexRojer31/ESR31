...
$sql_require_post = "SELECT title, text, today, autor FROM posts WHERE id='{$post_id}'";
$result_require_post = mysqli_query($link, $sql_require_post);
$row_require_post = mysqli_fetch_array($result_require_post);
$theme_title = $row_require_post["title"];
$theme_text = $row_require_post["text"];
$theme_today = $row_require_post["today"]; 
$theme_autor = $row_require_post["autor"];
...
.comment input[type=submit]:hover {
	...
	<div class="comment">
<?php
$sql_require_comment = "SELECT text, autor FROM comments WHERE topic_id='{$post_id}' ORDER BY id";
